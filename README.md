...
The uAPI Python library provides convenient access to the uAPI REST API from any Python 3.9+
...
These methods return an [`APIResponse`](https://github.com/uapiq/usdk-python/tree/main/src/uapi/_response.py) object.

The async client returns an [`AsyncAPIResponse`](https://github.com/uapiq/usdk-python/tree/main/src/uapi/_response.py) with the same structure, the only difference being `await`able methods for reading the response content.
...
We are keen for your feedback; please open an [issue](https://www.github.com/uapiq/usdk-python/issues) with questions, bugs, or suggestions.
