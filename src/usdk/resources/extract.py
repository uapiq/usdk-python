...
from ..types import extract_retrieve_params
...
class ExtractResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> ExtractResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/usdk-python#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> ExtractResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/usdk-python#with_streaming_response
        """
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=maybe_transform({"url": url}, extract_retrieve_params.ExtractRetrieveParams),
            ),
            cast_to=object,
        )
        ...
        *,
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"url": url}, extract_retrieve_params.ExtractRetrieveParams),
            ),
            cast_to=object,
        )
